...
We are trying to tackle the components of Place Recognition and Pose Recognition using Deep Learning. Thw work done by us is explained in [Section 3](#3.-place-recognition) and [Section 4](#Pose) below
